        ...
        <Row className="flex-grow-1 h-100">
          <Col lg={2} className="pe-1 align-items-center justify-content-center d-md-flex me-auto my-2 my-lg-0">
            <Col className="d-flex justify-content-md-center align-items-center">
              <Link to="/" className="text-decoration-none text-dark d-flex align-items-center justify-content-center">
              ...
              <Col className="h-100 d-flex d-md-none align-items-center justify-content-end">
                ...
                >
                  <span className={`${location.pathname.includes("/") ? "active" : ""}`}>Sign Up</span>
                </Link>
                <Link
                  to="/"
                  className="h-100 text-decoration-none text-dark d-flex align-items-center justify-content-center"
                >
                  <span className={`${location.pathname.includes("/") ? "active" : ""}`}>Log In</span>
                </Link>
              </Col>
            </Col>
          </Col>
          <Col md={12} lg={10} className="h-100 align-items-center d-none d-md-flex mb-md-2">
            <Col className="h-100">
              <Link
                ...
                className="h-100 text-decoration-none text-dark d-flex align-items-center justify-content-center "
              >
                <span className={`${location.pathname.includes("/") ? "active" : ""}`}>Home</span>
              </Link>
            </Col>
            <Col md={3} className="h-100">
              <Link
                ...
                className="h-100 text-decoration-none text-dark d-flex  align-items-center justify-content-center"
              >
                <span className={`${location.pathname.includes("/") ? "active" : ""}`}>Make an appointment</span>
              </Link>
            </Col>
            <Col className="h-100">
              <Link
                ...
                className="h-100 text-decoration-none text-dark d-flex align-items-center justify-content-center"
              >
                <span className={`${location.pathname.includes("/") ? "active" : ""}`}>About</span>
              </Link>
            </Col>
            <Col className="h-100">
              <Link
                ...
                className="h-100 text-decoration-none text-dark d-flex align-items-center justify-content-center"
              >
                <span className={`${location.pathname.includes("/") ? "active" : ""}`}>Profile</span>
              </Link>
            </Col>
            <Col className="h-100">
              <Link
